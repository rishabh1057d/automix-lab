...
Correction to the early planning report: Open-Unmix **UMXL** weights are noncommercial, while the [UMX-HQ Zenodo deposit](https://zenodo.org/records/3370489) identifies its weights as MIT. Neither is used in this implementation; vocal likelihood is labelled as a heuristic.
