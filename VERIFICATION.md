...
14 tests passed (8 engine, 6 API), final run 4.016 seconds. `node --check static/app.js` also passed. No line-coverage percentage was measured.
...
- Voice-like activity is a heuristic, not reliable singer-onset detection. Queue order is user-supplied; recommendations are not implemented.
